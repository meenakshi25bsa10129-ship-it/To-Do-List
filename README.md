...
1.  *Save the Code:* Copy the provided Python code and save it into a file named **todo.py** on your computer.
2.  *Open Terminal:* Navigate to the directory where you saved todo.py using your command prompt or terminal.
...
2.  Enter the task "Buy groceries".
3.  Select option *1* again.
4.  Enter the task "Finish report".
...
1.  Ensure you have at least two tasks (as per Test Case 1).
2.  Select option *3* (Delete Task).
3.  When prompted, enter the number *1*.
